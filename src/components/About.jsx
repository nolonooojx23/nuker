				...
				<div className="about-card w-full my-20 flex justify-between items-center flex-wrap max-lg:justify-center gap-10 ">
					<div className="about-card-imgs flex justify-center items-center gap-10 max-sm:gap-6">
						<div className="about-card-img flex flex-col justify-center items-center gap-10">
							<motion.img variants={AboutAnimationSecond} custom={2} className='w-[200px] animate__animated animate__fadeInUp wow' src={AboutImg1} alt="" />
							<motion.img variants={AboutAnimationSecond} custom={3} className='w-[200px] animate__animated animate__fadeInUp wow' src={AboutImg2} alt="" />
						</div>
						<div className="about-card-img">
							<motion.img variants={AboutAnimationSecond} custom={4} className='w-[200px] animate__animated animate__fadeInUp wow' src={AboutImg3} alt="" />
						</div>
					</div>
					<motion.div variants={AboutAnimationFirst} className="about-card-text py-10 px-5 w-1/2 max-lg:w-full animate__animated animate__fadeInUp wow">
