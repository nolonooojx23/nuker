		...
		<motion.div
			...
			<div className="home-header w-full flex justify-between items-center gap-10 py-10 px-16 max-lg:flex-wrap max-lg:justify-center max-lg:px-10 max-sm:px-5 max-[430px]:px-2">
				<motion.div className="home-header-text w-1/2 max-lg:w-full" variants={HomeAnimationFirst}>
					...
					<p className='max-[430px]:hidden mt-10 text-xl max-lg:text-base max-md:text-lg max-sm:text-base max-[430px]:text-sm max-[430px]:text-center max-sm:mt-4 max-[430px]:mt-5'>{t("Наше агентство проложит путь для развития вашего бизнеса,от открытия до первых продаж,произведем положительное впечатление на публику и найдем вашего клиента.Мы стремимся к действиям,которые принесут пользу в долгосрочной перспективе и создадим для вас максимальные результат и шансы удержаться на рынке.Свяжитесь с нами сейчас и стройте вместе светлое будущее своего бизнеса!")}</p>
