		...
		<motion.div
			...
			<div className="home-header w-full flex justify-between items-center gap-10 py-10 px-16 max-lg:flex-wrap max-lg:px-10 max-sm:px-5 max-[430px]:px-2">
				<motion.div className="home-header-text w-1/2 max-md:w-full" variants={HomeAnimationFirst}>
					...
					'>{t("Комплексно организуем и проведем рекламное")}<span className='text-[blue]'> {t("мероприятие в Узбекистане.")}</span></h1>
					<p className=' mt-10 text-xl max-lg:text-base max-md:text-lg max-sm:text-base max-[430px]:text-sm max-sm:mt-4'>{t("Сотрудничество с нашим агентством откроет перед вами новые возможности для роста и процветания вашего бизнеса. Мы стремимся к долгосрочным партнерским отношениям и готовы внести максимальный вклад в ваш успех. Свяжитесь с нами прямо сейчас и давайте вместе построим успешное будущее для вашего бизнеса!")}</p>
					<Link to='/contact'>
