...
function Card({ name, img, id }) {
	...
	return (
		...
		variants={CardAnimation}
			custom={id}
			viewport={{once: true}}
			className="service-card bg-white rounded-[10px] mt-5 w-[200px] h-[200px] max-[430px]:w-[150px] max-[430px]:h-[150px] flex flex-col justify-center items-center relative" onClick={() => {
