	...
	return (
		<div className='contact fixed top-0 left-0 w-full h-[100vh] z-[100000] flex justify-center items-center'>
			<div className="contact-card bg-white w-[400px] min-h-[450px] relative rounded-2xl flex-col justify-start items-center px-10 py-10 flex max-md:w-[350px] max-md:px-5 max-[430px]:px-2 animate__animated animate__fadeInDown">
				...
				<div className="text-[royalblue] text-[30px] font-semibold flex justify-center items-center max-md:text-[25px]">{t("Наши контакты")}</div>
				<div className="mt-5 text-[royalblue] text-[20px] font-semibold flex justify-center items-center cursor-pointer select-none max-md:text-[18px] max-md:mt-2" ><LocalPhoneIcon /><a href='tel:+998903002200'>
				+998903002200
    </a></div>
				...
				gap-[10px] w-[300px] max-md:w-[260px] bg-white py-[20px] rounded-[10px]">
					...
					<button className='p-[8px] outline-none rounded-lg text-[16px] bg-[royalblue] text-white cursor-pointer mt-5'>{t("Отправить")}</button>
				</form>
